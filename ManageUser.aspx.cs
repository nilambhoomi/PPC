...
{
    ILog log = log4net.LogManager.GetLogger(typeof(ManageUser));
    ...
    public DataSet BindUserDetails(int pageIndex = 1, string sortorder = "asc", string columnname = "FirstName")
    {
        DataSet lds = null;
        int totalrecords = 0;
        ...
        using (SqlConnection gConn = new SqlConnection(ConfigurationManager.ConnectionStrings["connString_NV_Jo"].ConnectionString))
        {
            try
            {
                ...
                SqlCommand gComm = new SqlCommand("nusp_GetUsers_paging", gConn);
    ...
    protected void Page_Changed(object sender, EventArgs e)
    {
        ...
        this.BindUserDetails(pageIndex);
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            cnd = " where  firstname like '%" + txtSearch.Text + "%' or lastname like '%" + txtSearch.Text + "%' or Designation like '%"+ txtSearch.Text +"%'";
        }
