...
prevPage= Request.UrlReferrer.ToString(); 
    ...
    protected void bindProcedures(string _bodypart, string _datetype)
    {
        ...
        { _procedures = _bl.GetProceduresByBody(_bodypart).Where(s => s.DateType == _datetype).Distinct<Procedure>(new ProcedureEqualityComparer()).ToList<Procedure>(); }
        ...
        foreach (string _injuredbodypart in _injuredBodyParts)
        {
            ...
            foreach (string _proc in _procedures.Distinct<Procedure>(new ProcedureEqualityComparer()).Select(s => s.MCode).ToList<string>())
            {
                ...
                foreach (string _subProcedure in _proceduredetails.Distinct(new subProcedureEqualityComparer()).Select(s => s.SubProcedure).ToList<string>())
                {
                    ...
                    if (_pdRequested != null)
                    {
                        if (_proc == _pdRequested.MCODE)
                        {
                        ...
                        _tcRequestedLabel.ID = _injuredbodypart + _proc + "RequestedLabel"+i;
                    ...
                    else if (_pdScheduled != null)
                    {
                        if (_proc == _pdScheduled.MCODE)
                        {
                            _tcSubProcedureTitle.Text = _subProcedure;
                            _tbProcedure.CssClass = "text-center border caption-align";
                            _tbProcedure.ID = _injuredbodypart + "_" + _proc;
                        ...
                        _tcScheduledLabel.ID = _injuredbodypart + _proc + "ScheduledLabel"+i;
                    ...
                    else if (_pdExecuted != null)
                    {
                        if (_proc == _pdExecuted.MCODE)
                        {
                            _tcSubProcedureTitle.Text = _subProcedure;
                            _tbProcedure.CssClass = "text-center border caption-align";
                            _tbProcedure.ID = _injuredbodypart + "_" + _proc;
                        ...
                        _tcExecutedLabel.ID = _injuredbodypart + _proc + "ExecutedLabel"+i;
