...
public partial class ViewInsCo : System.Web.UI.Page
{
    ILog log = log4net.LogManager.GetLogger(typeof(ViewInsCo));
    ...
    public DataSet bindInsCoDetails(int pageIndex = 1, string sortorder = "asc", string columnname = "InsCo")
    {
        DataSet lds = null;
        int totalrecords = 0;
        ...
        using (SqlConnection gConn = new SqlConnection(ConfigurationManager.ConnectionStrings["connString_NV_Jo"].ConnectionString))
        {
            try
            {
                ...
                gComm.Parameters.AddWithValue("@cnd", ViewState["_query"]);
                ...
                if (totalrecords > 0)
                {
                    gvInsCoDetails.DataSource = lds;
                    gvInsCoDetails.DataBind();
                }
                else
                {
                    gvInsCoDetails.DataSource = null;
                    gvInsCoDetails.DataBind();
                }
    ...
    protected void Page_Changed(object sender, EventArgs e)
    {
        ...
        this.bindInsCoDetails(pageIndex);
    }
    ...
    protected void lnkDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string SP = "nusp_Delete_InsCos";
            SqlParameter[] param = new SqlParameter[1];



            param[0] = new SqlParameter("@InsCo_ID", lnkdelete.CommandArgument);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            cnd = " where InsCo like '%" + txtSearch.Text + "%' or City like '%" + txtSearch.Text + "%' or State like '%" + txtSearch.Text + "%' or Emailaddress like '%" + txtSearch.Text + "%' or ContactPerson like '%" + txtSearch.Text + "%'";
        }
