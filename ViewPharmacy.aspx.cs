...
public partial class ViewPharmacy : System.Web.UI.Page
{
    ...
    ILog log = log4net.LogManager.GetLogger(typeof(ViewPharmacy));
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ViewState["_query"] = "";
            bindPharmacyDetails(1);
        }
    }

    public DataSet bindPharmacyDetails(int pageIndex = 1, string sortorder = "asc", string columnname = "Pharmacy")
    {
        DataSet lds = null;
        int totalrecords = 0;
        ...
        using (SqlConnection gConn = new SqlConnection(ConfigurationManager.ConnectionStrings["connString_NV_Jo"].ConnectionString))
        {
            try
            {
                ...
                if (totalrecords > 0)
                {
                    gvPharmacyDetails.DataSource = lds;
                    gvPharmacyDetails.DataBind();
                }
                else
                {
                    gvPharmacyDetails.DataSource = null;
                    gvPharmacyDetails.DataBind();
                }
    ...
    protected void Page_Changed(object sender, EventArgs e)
    {
        ...
        this.bindPharmacyDetails(pageIndex);
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            cnd = " where Pharmacy like '%" + txtSearch.Text + "%' or City like '%" + txtSearch.Text + "%' or State like '%" + txtSearch.Text + "%' or Emailaddress like '%" + txtSearch.Text + "%' or ContactPerson like '%" + txtSearch.Text + "%'";
        }
    ...
    protected void lnkDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string SP = "nusp_Delete_Pharmacy";
            SqlParameter[] param = new SqlParameter[1];



            param[0] = new SqlParameter("@Pharmacy_ID", lnkdelete.CommandArgument);
