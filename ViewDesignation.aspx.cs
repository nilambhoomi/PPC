...
{
    ILog log = log4net.LogManager.GetLogger(typeof(ViewDesignation));
    ...
    public DataSet bindProviderDetails(int pageIndex = 1, string sortorder = "asc", string columnname = "designation")
    {
        DataSet lds = null;
        int totalrecords = 0;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            cnd = " where designation like '%" + txtSearch.Text + "%' ";
        }
