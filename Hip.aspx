<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PageMainMaster.master" CodeFile="Hip.aspx.cs" Inherits="Hip" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                        <div id="wrpLeft" runat="server">
                            ...
                            <label class="control-label">The hip pain is worsened with &nbsp;</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                        ...
                        <div id="wrpRight2" runat="server">
                            ...
                            <asp:CheckBox ID="chkGreaterTrochanterRight" runat="server" Checked="true" Text="greater trochanter,  " />
                            ...
                            <tr>
                                <th>
                                    <table style="width: 400px">
                                        ...
                                        <tr>
                                            <td class="table_cell">
                                                <label>Lower Extremity</label></td>
                                            <td class="table_cell">
                                                <label>Left</label></td>
                                            <%--<td class="table_cell" ><label>Is </label></td>--%>
                                            <td class="table_cell">
                                                <label>Right</label></td>
                                            <%--<td class="table_cell" ><label>Is  </label></td>--%>
                                            <td class="table_cell">
                                                <label>Normal</label></td>
                                        </tr>
                                        <tr>
                                            <td class="table_cell">
                                                <label>Flexion</label></td>
                                            <%--<td>
                                ...
                                <th>
                                    <table style="width: 300px; margin-left: 20px">
                                        <tr>
                                            <td class="table_cell"></td>
                                            <td class="table_cell">
                                                <label>Ober's test </label>
                                            </td>
                                            <td class="table_cell">
                                                <label>FABER test </label>
                                            </td>
                                            <td class="table_cell">
                                                <label>Trendelenburg test </label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="table_cell">
