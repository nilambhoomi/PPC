...
public partial class patientdocuments : System.Web.UI.Page
{
    ...
    private void getPatietDetail()
    {
        try
        {
            DataTable dt = new DBHelperClass().selectDatatable("select Patient_ID,DOA from tblPatientIE where PatientIE_ID=" + Request["PatientIE_ID"].ToString());
