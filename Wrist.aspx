 <%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PageMainMaster.master" CodeFile="Wrist.aspx.cs" Inherits="Wrist" %>
            ...
            <div class="col-lg-10" id="content">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                        <div id="WrapLeft" runat="server">
                                ...
                                <label class=control-label> The patient complains of left wrist pain increases with specifically at the </Label>
                                <asp:CheckBox ID="chkulnarLeft" runat="server" Text="ulnar   " />
                                <asp:CheckBox ID="chkradiusLeft" runat="server" Text="radius  " Checked="true" />
                                <asp:CheckBox ID="chkDorsalLeft" runat="server" Text="dorsal of the wrist  " Checked="true" />
                        ...
                        <div id="wrpRight" runat="server">
                                ...
                                <label class=control-label>The patient complains of right wrist pain increases with specifically at the &nbsp;</Label>
                                <asp:CheckBox ID="chkulnarRight" runat="server" Text="ulnar   " />
                                <asp:CheckBox ID="chkradiusRight" runat="server" Text="radius  " Checked="true" />
                                <asp:CheckBox ID="chkDorsalRight" runat="server" Text="dorsal of the wrist  " Checked="true" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                                <div id="wrpPELeft" runat="server">
                                    <asp:Label runat="server" Text="The left wrist exam reveals tenderness upon palpation of the left" Font-Bold="False"></asp:Label>
                                    <asp:CheckBox ID="chkPalpationUlnarLeft" runat="server" Text="ulnar   " Checked="true" />
                                    <asp:CheckBox ID="chkPalpationRadialLeft" runat="server" Text="radius " />
                                    <asp:CheckBox ID="chkPalpationDorsalLeft" runat="server" Text="dorsal   " Checked="true" />
                                ...
                                <div id="wrpPERight" runat="server">
                                    <asp:Label runat="server" Text="The right wrist exam reveals tenderness upon palpation of the right" Font-Bold="False"></asp:Label>
                                    <asp:CheckBox ID="chkPalpationUlnarRight" runat="server" Text="ulnar   " Checked="true" />
                                    <asp:CheckBox ID="chkPalpationRadialRight" runat="server" Text="radius " />
                                    <asp:CheckBox ID="chkPalpationDorsalRight" runat="server" Text="dorsal   " Checked="true" />
