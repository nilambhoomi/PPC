...
public partial class Page3 : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (ds.Tables[0].Rows.Count == 0)
        {
            ...
            query = query + "Bowel,RecentWeightloss,Episodic,Rashes,PatientIE_ID,NightSweats,DoubleVision,HearingLoss,Depression,ISFirst) values (";
            ...
            query = query + "'" + txtIntactExcept.Text + "','" + LEdtr.Checked + "','" + RTricepstxt.Text + "','" + LTricepstxt.Text + "','" + RBicepstxt.Text + "','" + LBicepstxt.Text + "','" + RBrachioradialis.Text + "','" + LBrachioradialis.Text + "','" + UExchk.Checked + "','" + LKnee.Text + "','" + RKnee.Text + "','" + LAnkle.Text + "','" + RAnkle.Text + "','" + txtSensory.Text + "','" + chkPinPrick.Checked + "','" + chkLighttouch.Checked + "',";//
            ...
            query = query + "'" + chk_sleep_disturbance.Checked + "','" + chk_blurred.Checked + "','" + chk_hearing_loss.Checked + "','" + chk_depression.Checked + "',1 )";
        }
        else
        {
        ...
        if (bpActive)
        {
            ...
            else
            {
                ...
                query = query + "LegBilateral2='" + chk_numbess_in_leg.Checked + "',WeeknessIn='" + (chk_weakness_in_leg.Checked ? "Leg." : "") + "' Where PatientIE_ID=" + Session["PatientIE_ID"].ToString();
            }
            ds.Dispose();
    ...
    private void DefaultValue()
    {
        ...
        foreach (XmlNode node in nodeList)
        {
            ...
            TextBox24.Text = node.SelectSingleNode("LELumberParaspinalsRight").InnerText;
            TextBox25.Text = node.SelectSingleNode("LELumberParaspinalsLeft").InnerText;
