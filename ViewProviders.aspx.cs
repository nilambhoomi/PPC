...
public partial class ViewProviders : System.Web.UI.Page
{
    ILog log = log4net.LogManager.GetLogger(typeof(ViewProviders));
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ViewState["_query"] = "";
            bindProviderDetails(1);
        }
    }

    public DataSet bindProviderDetails(int pageIndex = 1, string sortorder = "asc", string columnname = "Provider")
    {
        DataSet lds = null;
        int totalrecords = 0;

        using (SqlConnection gConn = new SqlConnection(ConfigurationManager.ConnectionStrings["connString_NV_Jo"].ConnectionString))
        {
            try
            {
                ...
                if (totalrecords > 0)
                {
                    gvProviderDetails.DataSource = lds;
                    gvProviderDetails.DataBind();
                }
                else
                {
                    gvProviderDetails.DataSource = null;
                    gvProviderDetails.DataBind();
                }
    ...
    protected void Page_Changed(object sender, EventArgs e)
    {
        ...
        this.bindProviderDetails(pageIndex);
    }
    ...
    protected void lnkDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string SP = "nusp_Delete_Provider";
            SqlParameter[] param = new SqlParameter[1];



            param[0] = new SqlParameter("@Provider_ID", lnkdelete.CommandArgument);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            cnd = " where Provider like '%" + txtSearch.Text + "%' or City like '%" + txtSearch.Text + "%' or State like '%" + txtSearch.Text + "%' or Emailaddress like '%" + txtSearch.Text + "%' or ContactPerson like '%" + txtSearch.Text + "%'";
        }
