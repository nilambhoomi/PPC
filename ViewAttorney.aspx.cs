...
public partial class ViewAttorney : System.Web.UI.Page
{
    ILog log = log4net.LogManager.GetLogger(typeof(ViewAttorney));
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ViewState["_query"] = "";
            bindLoactionDetails(1);
        }
    }

    public DataSet bindLoactionDetails(int pageIndex = 1, string sortorder = "asc", string columnname = "Attorney")
    {
        DataSet lds = null;
        int totalrecords = 0;
    ...
    protected void Page_Changed(object sender, EventArgs e)
    {
        ...
        this.bindLoactionDetails(pageIndex);
    }
    ...
    protected void lnkDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string SP = "nusp_Delete_Attorney";
            SqlParameter[] param = new SqlParameter[1];



            param[0] = new SqlParameter("@Attorney_ID", lnkdelete.CommandArgument);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            cnd = " where Attorney like '%" + txtSearch.Text + "%' or City like '%" + txtSearch.Text + "%' or State like '%" + txtSearch.Text + "%' or Emailaddress like '%" + txtSearch.Text + "%' or ContactPerson like '%" + txtSearch.Text + "%'";
        }
