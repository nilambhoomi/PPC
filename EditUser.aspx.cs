...
public partial class EditUser : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                query = "insert into tblUserMaster(LoginID,Password,FirstName,LastName,MiddleName,eMailID,Signature,CreatedBy,CreatedDate,desig_id,GroupId,UserMasterId,Address,Ph_No,designation) values('" + txtLoginID.Text + "','" + txtuserpass.Text + "',";
                query = query + " '" + txtFirstName.Text + "','" + txtLastName.Text + "','" + txtMiddleName.Text + "','" + txtEmail.Text + "',Null,'admin',GETDATE()," + ddlDesig.SelectedItem.Value + "," + ddlGroup.SelectedItem.Value + ",'PPCPC','" + txtAddress.Text + "','" + txtPhoneNo.Text + "','" + ddlDesig.SelectedItem.Text + "') ";
            }
