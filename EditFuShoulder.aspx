<%@ Page Title="" Language="C#" MasterPageFile="~/FollowUpMaster.master" AutoEventWireup="true" CodeFile="EditFuShoulder.aspx.cs" Inherits="EditFuShoulder" %>
                ...
                <div class="row" style="margin-top: 15px">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                        ...
                        <div style="display: none">
                            <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn blue" OnClick="btnSave_Click" /></div>
                    </div>
                </div>
            </div>
        </div>
