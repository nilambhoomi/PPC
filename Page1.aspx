    ...
    <asp:UpdatePanel runat="server" ID="upMain">
        <ContentTemplate>
            ...
            <div class="form-horizontal">
                ...
                <div class="control-group span3">
                    <label class="control-label">DOV: </label>
                    <div class="controls">
            ...
            <div class="form-horizontal">
                ...
                <div class="control-group span3">
                 ...
                 <div class="control-group span3"  style="display:none">
                    ...
                    <div class="controls">
                        <asp:DropDownList runat="server" ID="ddlVaccinated" Width="100px">
            ...
            <div class="form-horizontal">
                <div class="control-group span3">
                    ...
                    <div class="controls">
                        <asp:TextBox ID="txtMAProviders" runat="server" Enabled="false"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="form-horizontal">
            ...
            <div class="form-horizontal" style="height: 250px;">
                <div class="controls">
                    <div style="display: none">
                        <asp:Button runat="server" ID="btnSave" OnClientClick="Validation();" Text="Save" OnClick="btnSave_Click" CssClass="btn btn-primary" TabIndex="33" ValidationGroup="save" />
                    </div>
