<%@ Page Language="C#" MasterPageFile="~/PageMainMaster.master" AutoEventWireup="true" CodeFile="Neck.aspx.cs" Inherits="Neck" %>
            ...
            <div class="col-lg-10" id="content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                        ...
                        <div class="col-md-9" style="margin-top: 5px">
                            <asp:TextBox runat="server" Style="float: left;" ID="txtFreeFormCC" TextMode="MultiLine" Width="700px" Height="100px"></asp:TextBox>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                        ...
                        <asp:TextBox Style="float: left; height: 15px;" Width="50px" ID="txtPalpationAt" runat="server"></asp:TextBox>
