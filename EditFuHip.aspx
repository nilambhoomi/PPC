<%@ Page Title="" Language="C#" MasterPageFile="~/FollowUpMaster.master" AutoEventWireup="true" CodeFile="EditFuHip.aspx.cs" Inherits="EditFuHip" %>
        ...
        <div class="row">
            <div class="col-lg-10" id="content">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                                <div id="wrpLeft" runat="server">
                                     <label class=control-label> The patient complains of </label>
                                <label class=control-label>&nbsp; Left hip pain that is &nbsp;</Label>
                                ...
                                <asp:CheckBox ID="chkAchyLeft" Style="" runat="server" Text="&nbsp;achy in nature.&nbsp;" />
                                    ...
                                    <asp:CheckBox ID="chkWorseSittingLeft" Style="" runat="server" Checked="true" Text="sitting,  " />
                                    <asp:CheckBox ID="chkWorseStandingLeft" Style="" runat="server" Checked="true" Text="standing,  " />
                                    <asp:CheckBox ID="chkWorseMovementLeft" runat="server" Style="" Text="movement,  " />
                                    <asp:CheckBox ID="chkWorseActivitiesLeft" runat="server" Style="" Text="activities  and &nbsp;  " />
                                    <asp:TextBox ID="txtWorseOtherLeft"  runat="server"></asp:TextBox>
                                </div><br />
                                <div id="wrpRight" runat="server">
                                     <label class="control-label"> The patient complains of</label>
                                <label class="control-label"> &nbsp;right hip pain that is &nbsp;</Label>
                               ...
                               <asp:CheckBox ID="chkContentRight" Style="" runat="server" Text="constant" />
                                ...
                                <asp:CheckBox ID="chkAchyRight" Style=""  runat="server" Text="achy in nature.  " />
                                    <asp:CheckBox ID="chkWorseSittingRight" Style="" runat="server" Checked="true" Text="sitting,  " />
                                    <asp:CheckBox ID="chkWorseStandingRight" Style="" runat="server" Checked="true" Text="standing,  " />
                                    <asp:CheckBox ID="chkWorseMovementRight" runat="server" Style="" Text="movement,  " />
                                    <asp:CheckBox ID="chkWorseActivitiesRight" runat="server" Style="" Text="activities  and  &nbsp;" />
                                    <asp:TextBox ID="txtWorseOtherRight"  runat="server"></asp:TextBox>
                                </div><br />
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                                ...
                                <div id="wrpLeft2" runat="server">
                                    <label class=control-label> There is tenderness upon palpation of the Left hip. </Label>
                                    <asp:CheckBox ID="chkGreaterTrochanterLeft" Style="" runat="server" Checked="true" Text="greater trochanter,  " />
                                    <asp:CheckBox ID="chkPosteriorLeft" Style="" runat="server" Text="posterior aspect of the greater trochanter,  " />
                                    <asp:CheckBox ID="chkIliotibialLeft" runat="server" Style="" Text="iliotibial band." /><br />
                                    <br />
                                </div>
                                <div id="wrpRight2" runat="server">
                                    <label class=control-label> There is tenderness upon palpation of the Right hip.  </Label>
                                    <asp:CheckBox ID="chkGreaterTrochanterRight" Style="" runat="server" Checked="true" Text="greater trochanter,  " />
                                    <asp:CheckBox ID="chkPosteriorRight" Style="" runat="server" Text="posterior aspect of the greater trochanter,  " />
                                    <asp:CheckBox ID="chkIliotibialRight" runat="server" Style="" Text="iliotibial band." /><br />
                                    <br />
                                </div>
                                <table>
                                    <tr>
                                        <th>
                                            <table style="width: 400px">
                                                <tr>
                                                    <td class="table_cell" ><label>ROM</label></td>
                                                ...
                                                <tr>
                                                    <td class="table_cell" ><label>Lower Extremity</label></td>
                                                    <td class="table_cell" ><label>Left</label></td>
                                                    <%--<td class="table_cell" ><label>Is </label></td>--%>
                                                    <td class="table_cell" ><label>Right</label></td>
                                                    <%--<td class="table_cell" ><label>Is  </label></td>--%>
                                                    <td class="table_cell" ><label>Normal</label></td>
                                                </tr>
                                                <tr>
                                                    <td class="table_cell"><label>Flexion</label></td>
                                                    <%--<td>
                                                        <asp:TextBox ID="txtFlexLeftWas" Width="50px" runat="server" ReadOnly="True" Text="30"></asp:TextBox></td>--%>
                                                    <td>
                                                        <asp:TextBox ID="txtFlexLeft" Width="50px" runat="server" Text="30"></asp:TextBox></td>
                                                    <%--<td>
                                                        <asp:TextBox ID="txtFlexRightWas" Width="50px" runat="server" ReadOnly="True" Text="30"></asp:TextBox></td>--%>
                                                    <td>
                                                        <asp:TextBox ID="txtFlexRight" Width="50px" runat="server" Text="30"></asp:TextBox></td>
                                                    <td>
                                                        <asp:TextBox ID="txtFlexNormal"  ReadOnly="true" Width="50px" runat="server"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <td class="table_cell"><label>Internal Rotation</label></td>
                                                   <%-- <td>
                                                        <asp:TextBox ID="txtIntRotationLeftWas" Width="50px" runat="server" ReadOnly="True" Text="30"></asp:TextBox></td>--%>
                                                    <td>
                                                        <asp:TextBox ID="txtIntRotationLeft" Width="50px" runat="server" Text="30"></asp:TextBox></td>
                                                    <%--<td>
                                                        <asp:TextBox ID="txtIntRotationRightWas" Width="50px" runat="server" ReadOnly="True" Text="30"></asp:TextBox></td>--%>
                                                    <td>
                                                        <asp:TextBox ID="txtIntRotationRight" Width="50px" runat="server" Text="30"></asp:TextBox></td>
                                                    <td>
                                                        <asp:TextBox ID="txtIntRotationNormal" ReadOnly="true" Width="50px" runat="server"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <td class="table_cell"><label>External Rotation</label></td>
                                                    <%--<td>
                                                        <asp:TextBox ID="txtExtRotationLeftWas" Width="50px" runat="server" ReadOnly="True" Text="30"></asp:TextBox></td>--%>
                                                    <td>
                                                        <asp:TextBox ID="txtExtRotationLeft" Width="50px" runat="server" Text="30"></asp:TextBox></td>
                                                    <%--<td>
                                                        <asp:TextBox ID="txtExtRotationRightWas" Width="50px" runat="server" ReadOnly="True" Text="30"></asp:TextBox></td>--%>
                                                    <td>
                                                        <asp:TextBox ID="txtExtRotationRight" Width="50px" runat="server" Text="30"></asp:TextBox></td>
                                                    <td>
                                                        <asp:TextBox ID="txtExtRotationNormal" ReadOnly="true" Width="50px" runat="server"></asp:TextBox></td>
                                                </tr>
                                            </table>
                                        </th>
                                        <th>
                                            <table style="width: 300px; margin-left:20px">
                                                <tr>
                                                    <td class="table_cell"></td>
                                                    <td class="table_cell"><label>Ober's test<br />
                                                        L</label></td>
                                                    <td class="table_cell"><label>FABER test<br />
                                                        R</label></td>
                                                    <td class="table_cell"><label>Trendelenburg test<br />
                                                        B</label></td>
                                                </tr>
                                                <tr>
                                                    <td class="table_cell"><label>Left</label></td>
                                                    ...
                                                    <td>
                                                        <asp:CheckBox ID="chkFaberLeft" runat="server" /></td>
                                                    <td>
                                                        <asp:CheckBox ID="chkTrendelenburgLeft" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                    <td class="table_cell"><label>Right</label></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:CheckBox ID="chkFaberRight" runat="server" /></td>
                                                    <td>
                                                        <asp:CheckBox ID="chkTrendelenburgRight" runat="server" /></td>
                                                </tr>
                                            </table>
                                        </th>
                                    </tr>
