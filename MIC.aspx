    ...
    <script>
        ...
        $(document).ready(function () {
            $('#rep_hospitalized input').change(function () {
                ...
                <button type="button" id="start_button" onclick="startButton(event)">Start</button>  
        ...
        if (!('webkitSpeechRecognition' in window)) {
           // upgrade();
            ...
            recognition.onend = function () {
                ...
                //    $('#ctl00_ContentPlaceHolder1_txtFreeForm').text(document.getElementById('final_span'));
                //}
