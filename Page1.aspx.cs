    ...
    public static string[] getFirstName(string prefix)
   {
    ...
    private void bindEditData(string PatientIEid)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            txt_DOV.Text = ds.Tables[0].Rows[0]["DOE"] != DBNull.Value ? Convert.ToDateTime(ds.Tables[0].Rows[0]["DOE"]).ToString("MM/dd/yyyy") : "";
           ...
           // ddl_casetype.ClearSelection();
            ...
            if (ds.Tables[0].Rows[0]["Vaccinated"] != DBNull.Value)
            {
                ddlVaccinated.ClearSelection();
                ddlVaccinated.Items.FindByValue(ds.Tables[0].Rows[0]["Vaccinated"].ToString()).Selected = true;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            param[15] = new SqlParameter("@DOV", txt_DOV.Text);
            ...
            Session["LocLbl"] = ddl_location.SelectedItem.Value;
            ...
            if (!string.IsNullOrEmpty(patientIE_ID))
            {
                ...
                param[33] = new SqlParameter("@PatientIE_ID", Session["PatientIE_ID"]);
            }
            //param[34] = new SqlParameter("@Vaccinated", ddlVaccinated.SelectedItem.Value);
