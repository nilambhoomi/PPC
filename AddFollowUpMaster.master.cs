                ...
                foreach (var i in (List<Body>)Session["FUFUbodyPartsList"])
                {
                    switch (i.Part)
                    {
                        case "Ankle":
                            ...
                            if (i.Position == "B") { Ankle_a.HRef = "FuAnkle.aspx?P=B"; } else if (i.Position == "L") { Ankle_a.HRef = "FuAnkle.aspx?P=L"; } else if (i.Position == "R") { Ankle_a.HRef = "FuAnkle.aspx?P=R"; }
                            break;
                        case "Shoulder":
                            lnkbtn_Shoulder.Visible = true;
                            if (i.Position == "B") { Shoulder_a.HRef = "FuShoulder.aspx?P=B"; } else if (i.Position == "L") { Shoulder_a.HRef = "FuShoulder.aspx?P=L"; } else if (i.Position == "R") { Shoulder_a.HRef = "FuShoulder.aspx?P=R"; }
                            break;

                        case "Knee":
                            lnkbtn_Keen.Visible = true;
                            if (i.Position == "B") { knee_a.HRef = "FuKnee.aspx?P=B"; } else if (i.Position == "L") { knee_a.HRef = "FuKnee.aspx?P=L"; } else if (i.Position == "R") { knee_a.HRef = "FuKnee.aspx?P=R"; }
                            break;

                        case "Wrist":
                            lnkbtn_Wrist.Visible = true;
                            if (i.Position == "B") { Wrist_a.HRef = "FuWrist.aspx?P=B"; } else if (i.Position == "L") { Wrist_a.HRef = "FuWrist.aspx?P=L"; } else if (i.Position == "R") { Wrist_a.HRef = "FuWrist.aspx?P=R"; }
                            break;

                        case "Hip":
                            lnkbtn_Hip.Visible = true;
                            if (i.Position == "B") { Hip_a.HRef = "FuHip.aspx?P=B"; } else if (i.Position == "L") { Hip_a.HRef = "FuHip.aspx?P=L"; } else if (i.Position == "R") { Hip_a.HRef = "FuHip.aspx?P=R"; }
                            break;

                        case "Neck":
                            lnkbtn_neck.Visible = true;
                            Neck_a.HRef = "FuNeck.aspx";
                            break;

                        case "MidBack":
                            lnkbtn_Midback.Visible = true;
                            Midback_a.HRef = "FuMidback.aspx";
                            break;

                        case "LowBack":
                            lnkbtn_lowback.Visible = true;
                            Lowback_a.HRef = "FuLowback.aspx";
                            break;

                        case "Elbow":
                            lnkbtn_Elbow.Visible = true;
                            if (i.Position == "B") { Elbow_a.HRef = "FuElbow.aspx?P=B"; } else if (i.Position == "L") { Elbow_a.HRef = "FuElbow.aspx?P=L"; } else if (i.Position == "R") { Elbow_a.HRef = "FuElbow.aspx?P=R"; }
                            break;
