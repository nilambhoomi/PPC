            ...
            <div class="col-lg-10" id="content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                        <asp:DropDownList Style="" DataSourceID="cboGAITDS" Width="100px" DataTextField="name" ID="cboGAIT" runat="server"></asp:DropDownList>
                        <asp:XmlDataSource ID="cboGAITDS" runat="server" DataFile="~/xml/HSMData.xml" XPath="HSM/GAITs/GAIT" />
                        <asp:DropDownList Style="" Width="300px" DataSourceID="cboAmbulatesDS" DataTextField="name" ID="cboAmbulates" runat="server"></asp:DropDownList>
                        ...
                        <table>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox Width="350px" ID="txtDiagCervialBulgeHNP2" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox Width="350px" ID="txtDiagThoracicBulgeHNP2" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox Width="350px" ID="txtDiagLumberBulgeHNP2" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox Width="350px" placeholder="Left Shoulder" ID="txtDiagLeftShoulderText" runat="server"></asp:TextBox>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox Width="350px" placeholder="Right Shoulder" ID="txtDiagRightShoulderText" runat="server"></asp:TextBox>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox Width="350px" placeholder="Left knee" ID="txtDiagLeftKneeText" runat="server"></asp:TextBox>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox Width="350px" placeholder="Right knee" ID="txtDiagRightKneeText" runat="server"></asp:TextBox>
                                </td>
                                <td></td>
                            </tr>
                            <%-- <tr>
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                        ...
                        <%-- <asp:GridView ID="dgvMedi" runat="server" AutoGenerateColumns="false">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:HiddenField ID="txtcc" runat="server" Value='<%# Eval("MedicationID") %>'></asp:HiddenField>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Medicine" ItemStyle-Width="450">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtpe" runat="server" Width="400" Text='<%# Eval("Medicine") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>--%>
