...
namespace IntakeSheet.BLL
{
    ...
    public class BusinessLogic
    {
        ...
        //public string savePatientProcedureDetail(long ProcedureMasterID, long _patientIEID, long? _patientFUID, long BodyPartID, long? ProcedureID, DateTime? Consider, DateTime? Requested, DateTime? Scheduled, DateTime? Followup, DateTime? Executed, string BodyPart, string Medication, string Muscle, string Level, string Req_Pos, string Sch_Pos, string Exe_Pos, string FU_Pos, int CreatedBy, int IsFromNew, int? PatientProcedureID, string req, Int16 IsConsidered,string Side,string SubCode)
        //{
        //    List<SqlParameter> param = new List<SqlParameter>();
        //    param.Add(new SqlParameter("@ProcedureMasterID", ProcedureMasterID));
        //    //param.Add(new SqlParameter("@SubProcedureID", SubProcedureID));
        ...
        public List<GetFuDetailsResult> GetFUDetails(int PatientIEId)
        {
