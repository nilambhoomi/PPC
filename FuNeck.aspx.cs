...
public partial class FuNeck : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Logger.Info(Session["uname"].ToString() + "- Visited in  FuNeck for -" + Convert.ToString(Session["LastNameFU"]) + Convert.ToString(Session["FirstNameFU"]) + "-" + DateTime.Now);
    ...
    {
        string ieMode = "New";
        string ieID = Session["PatientIE_ID2"].ToString();
        bool bpChecked = true;
        ...
        if (sqlTbl.Rows.Count > 0)
        {
          ...
          //  txtRotationNormal.Text = TblRow["RotationNormal"].ToString().Trim();
           ...
           // txtLateralFlexNormal.Text = TblRow["LateralFlexNormal"].ToString().Trim();
            ...
            SqlConnection cn1 = new SqlConnection(ConfigurationManager.ConnectionStrings["connString_NV_Jo"].ConnectionString);
            DBHelperClass db = new DBHelperClass();
    ...
    protected void AddStd_Click1(object sender, ImageClickEventArgs e)
    {
        ...
        SaveUI(_CurIEid, _FuId, ieMode, true);
        //SaveStandards(Session["PatientIE_ID2"].ToString());
        Response.Redirect("AddFuStandards.aspx");
