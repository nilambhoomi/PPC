...
public partial class SIDownloadSheetORTHO : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
            if (Request.QueryString["D"] != null)
            {
                ...
                System.Data.DataTable dt = getSIDownloadORTHO(date, out MAProviders);
    ...
    public DataTable getSIDownloadORTHO(DateTime date, out string providerMA)
    {
        ...
        param.Add(oparam);
        DataTable dt = dal.getOutParamDataTable("nusp_GetSISheetDetailsORTHO", param, out outputResult);
