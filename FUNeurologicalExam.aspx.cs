...
public partial class FUNeurologicalExam : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                string query = ("select count(*) as count1 FROM tblPatientIEDetailPage2 WHERE PatientIE_ID= " + Session["PatientIE_Id"].ToString() + "");
                ...
                if (Furw == null)
                {
                    ...
                    // DefaultValue();
                    PopulateUI(Session["PatientIE_Id"].ToString(), Session["patientFUId"].ToString(), "Open");
                }
                else if (rw == null)
                {
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(pageHDN.Value))
        {
