...
public partial class Lowback : System.Web.UI.Page
{
    ...
    public void PopulateUI(string ieID)
    {
        ...
        if (sqlTbl1.Rows.Count > 0)
        {
            ...
            //string RemText = "Iliolumbar syndrome (sprain of lumbar ligaments):  S33.5xxA, S33.5xxD";
            //if (Session["Lowbackdate"] != null)
    ...
    public void PopulateUIDefaults()
    {
        ...
        {
            _fldPop = true;
            txtPalpationAt.Text = node.SelectSingleNode("PalpationAt") == null ? txtPainScale.Text.ToString().Trim() : node.SelectSingleNode("PalpationAt").InnerText;
