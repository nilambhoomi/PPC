<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/AddFollowUpMaster.master" CodeFile="AddFUNeurologicalExam.aspx.cs" Inherits="AddFUNeurologicalExam" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpTitle" runat="Server">--%>
    ...
    <asp:UpdatePanel runat="server" ID="up_complains">
        <ContentTemplate>
            ...
            <p>
                ...
                <asp:CheckBox ID="chkPinPrick" runat="server" />Pinprick
                <asp:CheckBox Text="" runat="server" ID="chkLighttouch" />light touch. It is
                <asp:TextBox runat="server" ID="txtSensory"></asp:TextBox>
                <table>
                    <tr>
                        <td>
                            <table style="margin-right:50px;">
   ...
   <div style="display:none"> <asp:Button runat="server" Text="Save" CssClass="btn btn-primary" OnClick="btnSave_Click" ID="btnSave" UseSubmitBehavior="False" /></div>
    <asp:Button runat="server" ID="Button1" PostBackUrl="~/PatientIntakeList.aspx" Text="Back to List" CssClass="btn btn-default" UseSubmitBehavior="False" />
</asp:Content>
