...
public partial class PageMainMaster : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["PID"] != null)
        {
            patientdocument.HRef = "~/patientdocuments.aspx?PID="+Session["PID"].ToString();
        }
        ...
        {
            List<Body> b = new List<Body>(); Session["bodyPartsList1"] = b;
        ...
        {
            NameLbl.Text = Session["FirstNameIE"].ToString() +' '+ Session["LastNameIE"].ToString();
        }
        ...
        //{
        //    DVLbl.Text = Session["Location"].ToString();
        //}
        if (Session["bodyPartsList1"] != null)
        {
            var f = (List<Body>)Session["bodyPartsList1"];

            if (f != null)
                foreach (var i in (List<Body>)Session["bodyPartsList1"])
                {
                    switch (i.Part)
                    {
                        case "Ankle":                            
                                lnkbtn_ankle.Visible = true;
                                if (i.Position == "B") { Ankle_a.HRef = "Ankle.aspx?P=B"; } else if (i.Position == "L") { Ankle_a.HRef = "Ankle.aspx?P=L"; } else if (i.Position == "R") { Ankle_a.HRef = "Ankle.aspx?P=R"; }
                                 break;
                        case "Shoulder":
                                 lnkbtn_Shoulder.Visible = true;
                                 if (i.Position == "B") { Shoulder_a.HRef = "Shoulder.aspx?P=B"; } else if (i.Position == "L") { Shoulder_a.HRef = "Shoulder.aspx?P=L"; } else if (i.Position == "R") { Shoulder_a.HRef = "Shoulder.aspx?P=R"; }
                                 break;
                                            
                        case "Knee":
                                lnkbtn_Keen.Visible = true;
                                if (i.Position == "B") { knee_a.HRef = "Knee.aspx?P=B"; } else if (i.Position == "L") { knee_a.HRef = "Knee.aspx?P=L"; } else if (i.Position == "R") { knee_a.HRef = "Knee.aspx?P=R"; }
                            break;
                        
                        case "Wrist":
                            lnkbtn_Wrist.Visible = true;
                            if (i.Position == "B") { Wrist_a.HRef = "Wrist.aspx?P=B"; } else if (i.Position == "L") { Wrist_a.HRef = "Wrist.aspx?P=L"; } else if (i.Position == "R") { Wrist_a.HRef = "Wrist.aspx?P=R"; }
                           break;    
                    
                        case "Hip":
                            lnkbtn_Hip.Visible = true;
                            if (i.Position == "B") { Hip_a.HRef = "Hip.aspx?P=B"; } else if (i.Position == "L") { Hip_a.HRef = "Hip.aspx?P=L"; } else if (i.Position == "R") { Hip_a.HRef = "Hip.aspx?P=R"; }
                           break;
                        
                        case "Neck":
                            lnkbtn_neck.Visible = true;
                            Neck_a.HRef = "Neck.aspx";
                           break;

                        case "MidBack":
                             lnkbtn_Midback.Visible = true;
                             Midback_a.HRef = "Midback.aspx";
                            break;

                        case "LowBack":                           
                                lnkbtn_lowback.Visible = true;
                                Lowback_a.HRef ="Lowback.aspx";
                           break;

                        case "Elbow":                           
                                lnkbtn_Elbow.Visible = true;
                                if (i.Position == "B") { Elbow_a.HRef = "Elbow.aspx?P=B"; } else if (i.Position == "L") { Elbow_a.HRef = "Elbow.aspx?P=L"; } else if (i.Position == "R") { Elbow_a.HRef = "Elbow.aspx?P=R"; }
                           break;
        ...
        //lbtnProcedureDetails.HRef = "ProcedureDetails.aspx?PId=" + Convert.ToString(Session["PatientIE_ID"]);
        POC.HRef = "POC.aspx?PId=" + Convert.ToString(Session["PatientIE_ID"]);
    }
    ...
    protected void bindBodyParts(List<string> _injuredBodyParts)
    {
        ...
        var distinctList = bodylist.GroupBy(x => x.Part)
                         .Select(g => g.First())
                         .ToList();
        Session["bodyPartsList1"] = distinctList;
    ...
    //    if (Session["PatientIE_ID"] != null)
    //    {
    //        Response.Redirect("~/ProcedureDetails.aspx?PId=" + Convert.ToString(Session["PatientIE_ID"]));
    //    }
    ...
    //                {
    //                    case "LeftAnkle":
    //                        if (i.Checked || f.AsEnumerable().Where(c => c.Parts == "RightAnkle").Select(c => c.Checked).FirstOrDefault())
    //                        {
    //                            lnkbtn_ankle.Visible = true;
    //                        }
    //                        else
    ...
    //                        if (i.Checked || f.AsEnumerable().Where(c => c.Parts == "LeftAnkle").Select(c => c.Checked).FirstOrDefault())
    //                        {
    //                            lnkbtn_ankle.Visible = true;
    //                        }
    //                        else
    ...
    //                        break;
    //                    case "LeftShoulder":
    //                        if (i.Checked || f.AsEnumerable().Where(c => c.Parts == "RightShoulder").Select(c => c.Checked).FirstOrDefault())
    //                        {
    //                            lnkbtn_Shoulder.Visible = true;
    ...
    //                        } break;
    //                    case "RightShoulder":
    //                        if (i.Checked || f.AsEnumerable().Where(c => c.Parts == "LeftShoulder").Select(c => c.Checked).FirstOrDefault())
    //                        {
    //                            lnkbtn_Shoulder.Visible = true;
    //                        }
    //                        else
    ...
    //                        } break;
    //                    case "LeftKnee":
    //                        if (i.Checked || f.AsEnumerable().Where(c => c.Parts == "RightKnee").Select(c => c.Checked).FirstOrDefault())
    //                        {
    //                            lnkbtn_Keen.Visible = true;
    //                        }
    //                        else
    ...
    //                        } break;
    //                    case "RightKnee":
    //                        if (i.Checked || f.AsEnumerable().Where(c => c.Parts == "LeftKnee").Select(c => c.Checked).FirstOrDefault())
    //                        {
    //                            lnkbtn_Keen.Visible = true;
    //                        }
    //                        else
    ...
    //                        } break;
    //                    case "LeftWrist":
    //                        if (i.Checked || f.AsEnumerable().Where(c => c.Parts == "RightWrist").Select(c => c.Checked).FirstOrDefault())
    //                        {
    //                            lnkbtn_Wrist.Visible = true;
    //                        }
    //                        else
    ...
    //                        } break;
    //                    case "RightWrist":
    //                        if (i.Checked || f.AsEnumerable().Where(c => c.Parts == "LeftWrist").Select(c => c.Checked).FirstOrDefault())
    //                        {
    //                            lnkbtn_Wrist.Visible = true;
    //                        }
    //                        else
    ...
    //                        } break;
    //                    case "LeftHip":
    //                        if (i.Checked || f.AsEnumerable().Where(c => c.Parts == "RightHip").Select(c => c.Checked).FirstOrDefault())
    //                        {
    //                            lnkbtn_Hip.Visible = true;
    //                        }
    //                        else
    ...
    //                        } break;
    //                    case "RightHip":
    //                        if (i.Checked || f.AsEnumerable().Where(c => c.Parts == "LeftHip").Select(c => c.Checked).FirstOrDefault())
    //                        {
    //                            lnkbtn_Hip.Visible = true;
    //                        }
    //                        else
    ...
    //                        } break;
    //                    case "LeftElbow":
    //                        if (i.Checked || f.AsEnumerable().Where(c => c.Parts == "RightElbow").Select(c => c.Checked).FirstOrDefault())
    //                        {
    //                            lnkbtn_Elbow.Visible = true;
    //                        }
    //                        else
    ...
    //                        } break;
    //                    case "RightElbow":
    //                        if (i.Checked || f.AsEnumerable().Where(c => c.Parts == "LeftElbow").Select(c => c.Checked).FirstOrDefault())
    //                        {
    //                            lnkbtn_Elbow.Visible = true;
    //                        }
    //                        else
