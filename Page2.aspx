...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--  <asp:Panel ID="pnldynamic" runat="server"
                           ...
                           <iframe id="neckui" style="display:none;min-width:1300px; height:auto;
min-height: 2300px; overflow:auto;"></iframe>--%>
    <%-- <div>
    ...
    <div id="bodyui" style="margin-top: 15px">
        ...
        <div class="col-md-3">
            ...
            <br />
            <p>
                Accident description:<editable:EditableDropDownList runat="server" ID="ddl_accident_desc" Width="500px">
