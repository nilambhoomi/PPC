...
using System.IO;
public partial class EditFuWrist : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Logger.Info(Session["uname"].ToString() + "- Visited in  EditFuWrist for -" + Convert.ToString(Session["LastNameFUEdit"]) + Convert.ToString(Session["FirstNameFUEdit"]) + "-" + DateTime.Now);
    }
    public string SaveUI(string ieID, string fuID, string ieMode, bool bpIsChecked)
    {
        ...
        if (_ieMode == "Update" || _ieMode == "New")
        {
            ...
            TblRow["PainScaleRight"] = txtPainScaleLeft.Text.Trim();
    ...
    public void PopulateUI(string fuID)
    {
        ...
        if (sqlTbl1.Rows.Count > 0)
        {
            ...
            txtPainScaleLeft.Text = TblRow["PainScaleRight"].ToString().Trim();
