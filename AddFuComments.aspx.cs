...
public partial class AddFuComments : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Session["PatientIE_ID"] == null)
            {
                ...
                Response.Redirect("AddFUPage1.aspx");
        ...
        Logger.Info(Session["uname"].ToString() + "- Visited in  AddFuComments for -" + Convert.ToString(Session["LastNameFU"]) + Convert.ToString(Session["FirstNameFU"]) + "-" + DateTime.Now);
    }
