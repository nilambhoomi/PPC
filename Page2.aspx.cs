...
public partial class Page2 : System.Web.UI.Page
{
    ...
    private void bindData(string patientIEid)
    {
        ...
        query = "select worksat,PMH,PSH,Medications,Allergies,FamilyHistory,DeniesSmoking,DeniesDrinking,DeniesDrugs,DeniesSocialDrinking,Vitals from tblPatientIEDetailPage2 where PatientIE_ID=" + patientIEid;
