...
public partial class ViewLocations : System.Web.UI.Page
{
    ...
    ILog log = log4net.LogManager.GetLogger(typeof(ViewLocations));
    ...
    public DataSet bindLoactionDetails(int pageIndex = 1, string sortorder = "asc", string columnname = "Location")
    {
        DataSet lds = null;
        int totalrecords = 0;
    ...
    protected void lnkDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string SP = "nusp_Delete_Location";
            SqlParameter[] param = new SqlParameter[1];



            param[0] = new SqlParameter("@Location_ID", lnkdelete.CommandArgument);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            cnd = " where NameOfPractice like '%" + txtSearch.Text + "%' or Location like '%" + txtSearch.Text + "%' or City like '%" + txtSearch.Text + "%' or State like '%" + txtSearch.Text + "%' or Emailaddress like '%" + txtSearch.Text + "%' or ContactPerson like '%" + txtSearch.Text + "%'";
        }
