<%@ Page Title="" Language="C#" MasterPageFile="~/AddFollowUpMaster.master" AutoEventWireup="true" CodeFile="AddFUPage1.aspx.cs" Inherits="AddFUPage1" %>
            ...
            <div class="col-lg-10" id="content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                        <asp:DropDownList Style="" DataSourceID="cboGAITDS" Width="80px" DataTextField="name" ID="cboGAIT" runat="server"></asp:DropDownList>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox Width="150px"  ID="txtDiagCervialBulgeHNP2" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox Width="150px"  ID="txtDiagThoracicBulgeHNP2" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox Width="150px"  ID="txtDiagLumberBulgeHNP2" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
