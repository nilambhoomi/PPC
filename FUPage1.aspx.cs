...
public partial class FUPage1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Logger.Info(Session["uname"].ToString() + "- Visited in  EditFuPage1 for -" + Convert.ToString(Session["LastNameFUEdit"]) + Convert.ToString(Session["FirstNameFUEdit"]) + "-" + DateTime.Now);
       // BindDataGrid();
    ...
    public void BindDataGrid()
    {
        ...
        try
        {
            ...
            oSQLConn.ConnectionString = sProvider;
            oSQLConn.Open();
            SqlStr = "Select * from tblFUMedicationRx WHERE PatientFUId_ID = " + _CurFUid + " Order By Medicine";
