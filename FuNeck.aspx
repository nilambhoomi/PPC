<%@ Page Language="C#" MasterPageFile="~/AddFollowUpMaster.master" AutoEventWireup="true" CodeFile="FuNeck.aspx.cs" Inherits="FuNeck" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10" id="content">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <label class="control-label"><b><u>Trigger Point:</u></b></label></div>
                    <div class="col-md-9" style="margin-top: 5px">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <label class="control-label">Notes:</label></div>
                    <div class="col-md-9" style="margin-top: 5px">
                ...
                <div class="row" style="margin-top: 15px">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                        ...
                        <div style="display:none"><asp:Button ID="btnSave"  runat="server" Text="Save" OnClick="btnSave_Click" CssClass="btn blue" /></div>
