<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/AddFollowUpMaster.master" CodeFile="FuPoc.aspx.cs" Inherits="FuPoc" %>
   ...
   <%-- <script type="text/javascript" src='http://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.0.3/js/bootstrap.min.js'></script>--%>
    ...
    <script type="text/javascript">
        ...
        $('.date').keyup(function () {
            if (!this.value) {
                ...
                if (confirm('Do u want to delete?')) {
                    ...
                    if (ProcedureDetailIDfordelete == undefined)
                    { ProcedureDetailIDfordelete = 0 }
        ...
        function CountPopup(t) {
            ...
            $.ajax({
                type: "POST",
                url: "FuPoc.aspx/GetProcedureCountDetail",
        ...
        function considerPopup(t) {
            ...
            if (confirm('Are you sure you want to Delete this Consider?')) {
                $.ajax({
                    type: "POST",
                    url: "FuPoc.aspx/DeleteConsiderFromDB",
                    data: "{'ConID':'" + conID + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "JSON",
                    success: function (output) {
        ...
        function Popup(t) {
            ...
            if (t[0].dataset.subcode == "True") {
                $.ajax({
                    type: "POST",
                    url: "FuPoc.aspx/GetSubCodeFromDB",
            ...
            if (t[0].dataset.muscle == "True") {
                ...
                $.ajax({
                    type: "POST",
                    url: "FuPoc.aspx/GetMuscleFromDB",
            ...
            if (t[0].dataset.medication == "True") {
                ...
                $.ajax({
                    type: "POST",
                    url: "FuPoc.aspx/GetMedicationFromDB",
