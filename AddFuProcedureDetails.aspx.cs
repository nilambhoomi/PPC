...
public partial class AddFuProcedureDetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["PId"] != null)
            {
                ...
                hfPatientIE_ID.Value = Session["PatientIE_ID2"].ToString();
        ...
        //}
        Logger.Info(Session["uname"].ToString() + "- Visited in AddFuProcedureDetails for -" + Convert.ToString(Session["LastNameFU"]) + Convert.ToString(Session["FirstNameFU"]) + "-" + DateTime.Now);
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string count = _bl.saveProcedureDetail(
                ...
                Convert.ToInt64(hfPatientIE_ID.Value), Convert.ToInt64(hfPatientFU_ID.Value),
                _mcode,
                tokens[0],
