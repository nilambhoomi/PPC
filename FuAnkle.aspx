<%@ Page Title="" Language="C#" MasterPageFile="~/AddFollowUpMaster.master" AutoEventWireup="true" CodeFile="FuAnkle.aspx.cs" Inherits="FuAnkle" %>
...
<div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">                                <div id="wrpLeft1" runat="server">
                                    <label class=control-label> The patient complains of left ankle pain that is</label>
                                    <asp:TextBox ID="txtPainScaleLeft" Style="width:25px;" runat="server" ></asp:TextBox>
                                    ...
                                    <asp:CheckBox ID="chksharpLeft" Style="" runat="server" Text="sharp, " />
                                    <asp:CheckBox ID="chkelectricLeft" Style="" runat="server" Text="electric, " />
                                    <asp:CheckBox ID="chkshootingLeft" Style="" runat="server" Text="shooting, " />
                                    <asp:CheckBox ID="chkthrobbingLeft" Style="" runat="server" Text="throbbing, " />
                                    ...
                                    <asp:CheckBox ID="chkachyLeft" Style="" runat="server" Text="achy, " /> 
                                    <label class=control-label>&nbsp;in nature.&nbsp;</label>
                                    <label class=control-label> The patient complains of pain specifically at the</Label>
                                    <asp:CheckBox ID="chkMedMalleolusLeft" Style="" runat="server" Checked="true" Text="medial malleolus,  " />
                                    <asp:CheckBox ID="chkLatMalleolusLeft" Style="" runat="server" Checked="true" Text="lateral malleolus,  " />
                                    <asp:CheckBox ID="chkAchillesLeft" runat="server" Style="" Text="Achilles tendon." />
                                    <br />
                                    <br />
                                </div>
                                <div id="wrpRight1" runat="server">
                                    <label class=control-label>The patient complains of rigt ankle pain that is</Label>
                                    <asp:TextBox ID="txtPainScaleRight" Style="width:25px;" runat="server" ></asp:TextBox>
                                    <label class=control-label>/10 and</label>
                                    ...
                                    <asp:CheckBox ID="chksharpRight" Style="" runat="server" Text="sharp, " />
                                    <asp:CheckBox ID="chkelectricRight" Style="" runat="server" Text="electric, " />
                                    <asp:CheckBox ID="chkshootingRight" Style="" runat="server" Text="shooting, " />
                                    <asp:CheckBox ID="chkthrobbingRight" Style="" runat="server" Text="throbbing, " />
                                    ...
                                    <asp:CheckBox ID="chkachyRight" Style="" runat="server" Text="achy, " /> 
                                    <label class=control-label>&nbsp;in nature.&nbsp;</label>
                                    <label class=control-label> The patient complains of pain specifically at the</Label>
                                    <asp:CheckBox ID="chkMedMalleolusRight" Style="" runat="server" Checked="true" Text="medial malleolus,  " />
                                    <asp:CheckBox ID="chkLatMalleolusRight" Style="" runat="server" Checked="true" Text="lateral malleolus,  " />
                                    <asp:CheckBox ID="chkAchillesRight" runat="server" Style="" Text="Achilles tendon." />
                                    <br />
                                    <br />
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                                <asp:TextBox runat="server" ID="txtFreeFormCC" Style="" TextMode="MultiLine" Width="700px" Height="100px"></asp:TextBox>
                    ...
                    <div class="col-md-9" style="margin-top: 5px">
                                ...
                                <div id="wrpLeft2" runat="server">
                                    ...
                                    <label class=control-label>The left ankle ROM is</Label>
                                     <asp:DropDownList ID="cboRangeOfMotionLeft" DataSourceID="namesXML" DataTextField="name" runat="server" />
                                     <asp:XmlDataSource ID="namesXML" runat="server" DataFile="~/xml/HSMData.xml" XPath="HSM/ROMs/ROM" />
                                    <label class=control-label> decreased with local tenderness upon palpation of the  </Label>
                                ...
                                <div id="wrpRight2" runat="server">
                                    ...
                                    <asp:DropDownList ID="cboRangeOfMotionRight" DataSourceID="romright" DataTextField="name" runat="server" />
                                    <asp:XmlDataSource ID="romright" runat="server" DataFile="~/xml/HSMData.xml" XPath="HSM/ROMs/ROM" />
                                    <label class=control-label>decreased with local tenderness upon palpation of the </Label>
