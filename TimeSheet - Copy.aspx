...
<asp:Content ID="Content3" ContentPlaceHolderID="cpMain" runat="Server">
    ...
    <div class="modal fade" id="ProcedureDetailModal" role="dialog">
        <div class="modal-dialog">
                            ...
                            <ContentTemplate>
                                <table class="table" style="width: 70%; margin: 0 auto">
                                    <tr>
                                        <td>BodyPart :</td>
                                        <td>
                                            <asp:DropDownList ID="ddBodyPart" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddBodyPart_SelectedIndexChanged"></asp:DropDownList></td>
                                    </tr>
                                    <tr>
                                        <td>Type :</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Procedure :</td>
                                        <td>
                                            <asp:DropDownList ID="ddProcedure" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddProcedure_SelectedIndexChanged"></asp:DropDownList></td>
                                    </tr>
                                    <tr>
                                        <td>Sub Procedure :</td>
                                        <td>
                                            ...
                                            <asp:TextBox ID="txtNumber" Width="30px" Height="19px" runat="server"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>Date</td>
                                        <td>
                                            <asp:TextBox ID="txtDate" CssClass="dateonly" runat="server"></asp:TextBox></td>
                                    </tr>
                                </table>
